    ...
    namespace span_lite {
        ...
        namespace std11 {
            ...
            template <class T> struct remove_cv {
                typedef typename std11::remove_volatile<typename std11::remove_const<T>::type>::type
                    type;
            };
        ...
        namespace detail {
            ...
            template <typename T> span_constexpr bool is_positive(T x) {
...
#define span_sizeof(T) static_cast<extent_t>(sizeof(T))
        ...
        template <class T> inline span_constexpr size_t to_size(T size) {
        ...
        template <class T, extent_t Extent /*= dynamic_extent*/> class span {
          public:
            ...
            template <extent_t U = Extent span_REQUIRES_T((U != dynamic_extent))>
          ...
          private:
            ...
            template <typename U> static inline span_constexpr U *to_address(U *p) span_noexcept {
                return p;
            }
        ...
        span(It, EndOrSize)
            -> span<typename std11::remove_reference<typename std20::iter_reference_t<It>>::type>;
...
namespace nonstd {
    namespace span_lite {
        ...
        template <class T>
        inline span_constexpr span<const T> make_span(std::initializer_list<T> il) span_noexcept {
        ...
        template <class T> inline span_constexpr span<T> make_span(span<T> spn) span_noexcept {
            return spn;
        }
