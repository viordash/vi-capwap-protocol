...
struct WritableAddMacAclEntry : IWritableConfigurationUpdateRequestOptionalElement {
...
struct ReadableAddMacAclEntry : IReadableConfigurationUpdateRequestOptionalElement {
  public:
