...
TEST(DiscoveryRequestTestsGroup, DiscoveryRequest_serialize_with_VendorSpecificPayload) {
    ...
    write_data.Serialize(&raw_data);
    CHECK_EQUAL(&buffer[0] + 139 - (sizeof(ClearHeader) + sizeof(ControlHeader)), raw_data.current);
    const uint8_t reference[] = {
        0x00, 0x10, 0xC2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x2A, 0x00,
        0x73, 0x00, 0x00, 0x14, 0x00, 0x01, 0x02, 0x00, 0x26, 0x00, 0x14, 0x00, 0x00, 0x04,
        0xD2, 0x00, 0x00, 0x00, 0x04, 0x61, 0x62, 0x63, 0x64, 0x00, 0x01, 0x00, 0x04, 0x31,
        0x32, 0x33, 0x34, 0x00, 0x27, 0x00, 0x12, 0x0A, 0x03, 0x01, 0x01, 0x00, 0x00, 0x00,
        0x00, 0x04, 0xD2, 0x00, 0x01, 0x00, 0x04, 0x61, 0x62, 0x63, 0x64, 0x00, 0x29, 0x00,
        0x01, 0x02, 0x00, 0x2C, 0x00, 0x01, 0x00, 0x04, 0x18, 0x00, 0x05, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x25, 0x00, 0x1B, 0x00, 0x01, 0xE2, 0x40, 0x03, 0x15, 0x30, 0x31,
        0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30, 0x41, 0x42, 0x43, 0x44, 0x45,
        0x46, 0x30, 0x31, 0x32, 0x33, 0x00, 0x25, 0x00, 0x12, 0x00, 0x00, 0x00, 0x01, 0x00,
    ...
    raw_data = { buffer, buffer + 139 - (sizeof(ClearHeader) + sizeof(ControlHeader)) };
    ReadableDiscoveryRequest read_data;
    CHECK_TRUE(read_data.Deserialize(&raw_data));
...
TEST(DiscoveryRequestTestsGroup, DiscoveryRequest_serialize_with_MTUDiscoveryPadding) {
    ...
    const uint8_t reference[] = {
        ...
        0x00, 0x27, 0x00, 0x12, 0x0A, 0x03, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x04, 0xD2, 0x00,
        0x01, 0x00, 0x04, 0x61, 0x62, 0x63, 0x64, 0x00, 0x29, 0x00, 0x01, 0x02, 0x00, 0x2C, 0x00,
        0x01, 0x00, 0x04, 0x18, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x25, 0x00, 0x0A,
        0x00, 0x00, 0x30, 0x0C, 0x02, 0xBC, 0x30, 0x31, 0x32, 0x33, 0x00, 0x34, 0x00, 0xC4, 0xFF,
