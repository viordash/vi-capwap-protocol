...
TEST_GROUP(EchoRequestTestsGroup){ //
                                   TEST_SETUP(){}
...
TEST(EchoRequestTestsGroup, EchoRequest_serialize) {
    ...
    const uint8_t reference[] = { 0x00, 0x10, 0xC2, 0x00, 0x00, 0x00, 0x00, 0x00,
                                  0x00, 0x00, 0x00, 0x0D, 0x2A, 0x00, 0x00, 0x00 };
...
TEST(EchoRequestTestsGroup, EchoRequest_deserialize_image_data) {
    // clang-format off
    uint8_t data[] = {
...
TEST(EchoRequestTestsGroup, EchoRequest_deserialize_handle_unknown_element) {
    // clang-format off
    uint8_t data[] = {
        // ======== CAPWAP Header (8 байт) ========
        // Спецификация: RFC 5415, Section 4.3
