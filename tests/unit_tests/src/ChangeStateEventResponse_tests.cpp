...
TEST(ChangeStateEventResponseTestsGroup, ChangeStateEventResponse_serialize) {
    uint8_t buffer[4096] = {};
    ...
    const uint8_t reference[] = { 0x00, 0x10, 0xC2, 0x00, 0x00, 0x00, 0x00, 0x00,
                                  0x00, 0x00, 0x00, 0x0C, 0x2A, 0x00, 0x00, 0x00 };
...
TEST(ChangeStateEventResponseTestsGroup,
...
TEST(ChangeStateEventResponseTestsGroup, ChangeStateEventResponse_deserialize_image_data) {
    // clang-format off
    uint8_t data[] = {
        ...
        0x00, 0x00, 0x00, 0x0C, // Message Type = 12 (Change State Event Response)
...
TEST(ChangeStateEventResponseTestsGroup,
     ChangeStateEventResponse_deserialize_handle_unknown_element) {
    // clang-format off
    uint8_t data[] = {
        // ======== CAPWAP Header (8 байт) ========
        // Спецификация: RFC 5415, Section 4.3
