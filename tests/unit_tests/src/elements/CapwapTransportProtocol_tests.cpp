...
TEST(CapwapTransportProtocolTestsGroup, Wrapper_CapwapTransportProtocol_deserialize) {
    uint8_t data[] = {
        0x00, 0x33, 0x00, 0x01, 0x01,
    };
    RawData raw_data{ data, data + sizeof(data) };
...
TEST(CapwapTransportProtocolTestsGroup, Wrapper_CapwapTransportProtocol_serialize) {
    uint8_t buffer[256] = {};
