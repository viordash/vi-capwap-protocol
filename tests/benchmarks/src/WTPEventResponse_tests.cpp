...
TEST(WTPEventResponseTestsGroup, WTPEventResponse_serialize_deserialize_perf) {
    ankerl::nanobench::Bench b;

    b.title("WTPEventResponse").warmup(1000).minEpochIterations(300000).relative(true);
