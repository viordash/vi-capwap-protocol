...
TEST(ImageDataResponseTestsGroup, ImageDataResponse_serialize_deserialize_perf) {
    ankerl::nanobench::Bench b;

    b.title("ImageDataResponse").warmup(1000).minEpochIterations(150000).relative(true);
